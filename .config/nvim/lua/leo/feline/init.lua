...
local C = require('leo.feline.colors')
local hl = require('leo.feline.status').hl
local provider = require('leo.feline.status').provider
local conditional = require('leo.feline.status').conditional
